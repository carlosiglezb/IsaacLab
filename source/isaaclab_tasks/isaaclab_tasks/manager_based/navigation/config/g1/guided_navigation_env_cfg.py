...
class RewardsCfg:
    ...
    # -- penalty for tracking error of guides
    track_guide_torso_l2 = RewTerm(
        func=mdp.track_ee_guides_l2, weight=-0.5,
    ...
    # -- penalty for tracking error of guides
    track_guide_lf_l2 = RewTerm(
        func=mdp.track_ee_guides_l2, weight=-1.0,
        params={"asset_cfg": SceneEntityCfg("robot",
                                            joint_names=[".*"],
    ...
    # -- penalty for tracking error of guides
    track_guide_rk_l2 = RewTerm(
        func=mdp.track_ee_guides_l2, weight=-0.5,
        params={"asset_cfg": SceneEntityCfg("robot",
                                            joint_names=[".*"],
                                            body_names=["right_knee_link"]),
                "std": math.sqrt(0.2)}
    )
    # -- penalty for tracking error of guides
    track_guide_lh_l2 = RewTerm(
        func=mdp.track_ee_guides_l2, weight=-1.0,
        params={"asset_cfg": SceneEntityCfg("robot",
                                            joint_names=[".*"],
                                            body_names=["left_zero_link"]),
                "std": math.sqrt(0.2)}
    )
    # -- penalty for tracking error of guides
    track_guide_rh_l2 = RewTerm(
        func=mdp.track_ee_guides_l2, weight=-1.0,
        params={"asset_cfg": SceneEntityCfg("robot",
                                            joint_names=[".*"],
                                            body_names=["right_zero_link"]),
                "std": math.sqrt(0.2)}
    )
...
class CommandsCfg:
    ...
    pose_command = mdp.UniformPose2dCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformPose2dCommandCfg.Ranges(pos_x=(0.6, 0.8), pos_y=(-0.1, 0.1), heading=(-0.3, 0.3)),
    )
...
@configclass
class GuidedNavigationEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.episode_length_s = 15.0        # from optimized guides
...
class GuidedNavigationEnvCfg_PLAY(GuidedNavigationEnvCfg):
