...
from isaaclab_tasks.manager_based.locomotion.velocity.velocity_knee_knocker_env_cfg import LocomotionVelocityKneeKnockerEnvCfg, RewardsCfg
...
@configclass
class G1RoughKneeKnockerEnvCfg(LocomotionVelocityKneeKnockerEnvCfg):
...
@configclass
class G1RoughKneeKnockerEnvCfg_PLAY(G1RoughKneeKnockerEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
